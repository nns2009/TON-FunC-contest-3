...
def mul_x_fast(x, n):
	...
	for bi in range(255, -1, -1):
		...
		if not process:
			...
			continue
		low = double_XZ(xz0)
		mid = add_neighbour_XZ(xz0, xz1, x);
		high = double_XZ(xz1)
...
multiplied_x = mul_x_fast(mul_test_x, 4)
...
for i in range(1, mul_test_max + 1):
	if ps_seq[i][0] != mul_x_fast(base_x, i):
		mul_correct = False
...
print('Some info for FunC multiplication testing')
print(400, ps_seq[400][0])
print(500, ps_seq[500][0])
print(900, ps_seq[900][0])

print(2, ps_seq[1], ps_seq[2])
